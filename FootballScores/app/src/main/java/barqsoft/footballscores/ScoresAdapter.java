...
public class ScoresAdapter extends CursorAdapter
{
    ...
    public void bindView(View view, final Context context, Cursor cursor)
    {
        ...
        //Dynamic content description for the expandable list
        if(homeGoals < 0) {
            view.setContentDescription(mContext.getString(R.string.content_description_list_item_inactive,
                    homeName, awayName, matchTime));
        } else{
            view.setContentDescription(mContext.getString(R.string.content_description_list_item_active,
                    homeName, awayName, homeGoals, awayGoals, matchTime));
        }
